                                            ...
                                            <div className="flex_column_table av-equal-height-column-flextable -flextable">
                                                ...
                                                <div className="flex_column av_three_fifth  no_margin flex_column_table_cell av-equal-height-column av-align-middle   avia-builder-el-4  el_after_av_two_fifth  avia-builder-el-last  newslatter-frm "
                                                    ...
                                                    <div style={{ paddingBottom: "10px", margin: "0px 0px 0px 0px", color: "#53632e" }}
                                                        ...
                                                        <h1 className="av-special-heading-tag ">Mint&hellip;
                                                        </h1>
                                                    ...
                                                    {/* <div
												className="avia-button-wrap avia-button-center  avia-builder-el-8  el_after_av_button  avia-builder-el-last ">
												<button
													className="avia-button  avia-color-theme-color   avia-icon_select-no avia-size-small avia-position-center "><span
														className="avia_iconbox_title">Mint With
														Solana</span></button></div> */}
                                                </div>
                                            </div>
